...
public class TestingUtil
{
    ...
    static String selectDistinctPlayedGameIDs = "SELECT DISTINCT game_ID from gamesplayed WHERE player_ID = ?";
    ...
    static String selectDistinctOwnedGameIDs = "SELECT DISTINCT game_ID from gamesowned WHERE player_ID = ?";
